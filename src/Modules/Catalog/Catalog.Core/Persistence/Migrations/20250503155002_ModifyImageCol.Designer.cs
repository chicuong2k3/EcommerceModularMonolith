...
namespace Catalog.Core.Persistence.Migrations
{
    ...
    [Migration("20250503155002_ModifyImageCol")]
    partial class ModifyImageCol
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Catalog.Core.Entities.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Catalog.Core.ValueObjects.ProductVariantAttribute", b =>
                {
            ...
            modelBuilder.Entity("Catalog.Core.Entities.ProductVariant", b =>
                {
                    ...
                    b.OwnsOne("Catalog.Core.ValueObjects.Money", "OriginalPrice", b1 =>
                        {
                    ...
                    b.OwnsOne("Catalog.Core.ValueObjects.Money", "SalePrice", b1 =>
                        {
                            b1.Property<Guid>("ProductVariantId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Catalog.Core.ValueObjects.DateTimeRange", "SalePriceEffectivePeriod", b1 =>
                        {
                            b1.Property<Guid>("ProductVariantId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Catalog.Core.ValueObjects.Image", "Image", b1 =>
                        {
                            b1.Property<Guid>("ProductVariantId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Catalog.Core.Entities.Review", b =>
                {
                    ...
                    b.OwnsOne("Catalog.Core.ValueObjects.ReviewRating", "Rating", b1 =>
                        {
